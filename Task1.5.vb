Module Module1
    ...
    Sub Main()
        ...
        While UCase(AddMoreRecords) = "Y"
            ...
            Console.WriteLine("Enter ID Number of the Sports Club's Member  ")
        ...
        Dim MembershipStartingDate As String = ""

        FileOpen(1, "C:\Users\zunair\Downloads\Computer Science A levels\Filing\Task11.txt", OpenMode.Input)
        FileOpen(2, "C:\Users\zunair\Downloads\Computer Science A levels\Filing\Task11Misc.txt", OpenMode.Output)
        ...
        While Not EOF(1)
            ...
            Console.WriteLine("Enter Telephone Number for " & MemberName & ", MemberID: " & MemberIdNumber)
            TelephoneNumber = Console.ReadLine
            Console.WriteLine("Enter Membership Start Date for " & MemberName & ", MemberID: " & MemberIdNumber)
            MembershipStartingDate = Console.ReadLine

            WriteLine(2, MemberName)
            WriteLine(2, MemberIdNumber)
            WriteLine(2, TelephoneNumber)
            WriteLine(2, MembershipStartingDate)

        End While
        FileClose(1)
        FileClose(2)

        My.Computer.FileSystem.DeleteFile("C:\Users\zunair\Downloads\Computer Science A levels\Filing\Task11.txt")
        My.Computer.FileSystem.RenameFile("C:\Users\zunair\Downloads\Computer Science A levels\Filing\Task11Misc.txt", "Task11")
